...
const Word_Result = ({wordApi ,phoneticText ,nounMeaning,verbMeaning , synonymsApi}) => {
  return (
    <div className="w-[737px] border  mt-8">
        <Result_v1 wordApi ={wordApi} phoneticText={phoneticText} />
        <Result_v2 nounMeaning= {nounMeaning} verbMeaning={verbMeaning} synonymsApi={synonymsApi}/>
